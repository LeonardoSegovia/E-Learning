...
namespace Persistence.DatabaseContext
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<UsersPerCouse> UsersPerCouse { get; set; }
        public DbSet<CourseLeassonLearnedsPerUser> CourseLeassonLearnedsPerUser { get; set; }
        public DbSet<LeassonsPerCourse> LeassonsPerCourse { get; set; }
        public DbSet<Income> Income { get; set; }
        public DbSet<ReviewsPerCouse> ReviewsPerCouse { get; set; }
